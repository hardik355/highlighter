...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { code: @snippet.code, language: @snippet.language, name: @snippet.name } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { code: @snippet.code, language: @snippet.language, name: @snippet.name } }
